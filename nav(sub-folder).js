// This file handles navigation setup for sub-pages located in sub-folders.
// It ensures that the correct content is displayed when navigating to these sub-pages.
...
document.addEventListener('DOMContentLoaded', () => {
    // Determine the correct path for nav.html
    ...
    fetch(navPath)
        ...
        .then(data => {
            ...
            // Move the logo setup code here
            const logo = document.getElementById('brand-logo');
            logo.src = isSubPage ? '../logo/camera.jpg' : 'logo/camera.jpg';
...
function customizeNav() {
    ...
    const currentLinks = pageLinks[currentPage] || ['/', 'sub-page/about.html', 'sub-page/work.html', 'sub-page/contact.html'];
